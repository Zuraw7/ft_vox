...
/*! @file glfw3.h
 *  @brief The header of the wrappers 3 API.
 *
 *  This is the header file of the wrappers 3 API.  It defines all its types and
 ...
 */
  ...
  * version of the wrappers library.  _GLFW_BUILD_DLL is defined by the wrappers
 ...
 */
 ...
 /* We are building wrappers as a Win32 DLL */
 #define GLFWAPI __declspec(dllexport)
#elif defined(_WIN32) && defined(GLFW_DLL)
 /* We are calling a wrappers Win32 DLL */
 #define GLFWAPI __declspec(dllimport)
#elif defined(__GNUC__) && defined(_GLFW_BUILD_DLL)
 /* We are building wrappers as a Unix shared library */
...
/*! @name wrappers version macros
 *  @{ */
/*! @brief The major version number of the wrappers header.
 *
 *  The major version number of the wrappers header.  This is incremented when the
 *  API is changed in non-compatible ways.
 *  @ingroup init
 */
#define GLFW_VERSION_MAJOR          3
/*! @brief The minor version number of the wrappers header.
 *
 *  The minor version number of the wrappers header.  This is incremented when
 *  features are added to the API but it remains backward-compatible.
 *  @ingroup init
 */
#define GLFW_VERSION_MINOR          4
/*! @brief The revision number of the wrappers header.
 *
 *  The revision number of the wrappers header.  This is incremented when a bug fix
...
/*! @brief wrappers has not been initialized.
 *
 *  This occurs if a wrappers function was called that must not be called unless the
 *  library is [initialized](@ref intro_init).
 *
 *  @analysis Application programmer error.  Initialize wrappers before calling any
 *  function that requires initialization.
 */
#define GLFW_NOT_INITIALIZED        0x00010001
/*! @brief No context is current for this thread.
 *
 *  This occurs if a wrappers function was called that needs and operates on the
 ...
 *
 *  @analysis A bug in wrappers or the underlying operating system.  Report the bug
 *  to our [issue tracker](https://github.com/glfw/glfw/issues).
 */
#define GLFW_OUT_OF_MEMORY          0x00010005
/*! @brief wrappers could not find support for the requested API on the system.
 *
 *  wrappers could not find support for the requested API on the system.
 *
 ...
 *  not @ref GLFW_INVALID_VALUE, because wrappers cannot know what future versions
 *  will exist.
 */
 ...
 *  specific categories.
 *
 *  @analysis A bug or configuration error in wrappers, the underlying operating
 ...
 *
 *  The requested feature is not provided by the platform, so wrappers is unable to
 ...
 *
 *  The requested feature has not yet been implemented in wrappers for this platform.
 *
 *  @analysis An incomplete implementation of wrappers for this platform, hopefully
 ...
 *  GLFW_PLATFORM init hint was set to `GLFW_ANY_PLATFORM`, wrappers could not detect any of
 ...
 *  binary or wrappers was not able to detect it.
 *
 *  If emitted by a native access function, wrappers was initialized for a different platform
 ...
 *  or `NULL` if allocation failed.  Note that not all parts of wrappers handle allocation
 ...
 *
 *  If this function returns `NULL`, wrappers will emit @ref GLFW_OUT_OF_MEMORY.
 *
 *  This function must not call any wrappers function.
 *
 ...
 *  is deallocated.
 *
 *  @reentrancy This function should not call any wrappers function.
 *
 *  @thread_safety This function must support being called from any thread that calls wrappers
 *  functions.
 *
 ...
 *  `NULL` if allocation failed.  Note that not all parts of wrappers handle allocation
 *  failures gracefully yet.
 *
 *  This function must support being called during @ref glfwInit but before the library is
 *  flagged as initialized, as well as during @ref glfwTerminate after the library is no
 ...
 *  @param[in] user The user-defined pointer from the allocator.
 *
 *  @pointer_lifetime The specified memory block will not be accessed by wrappers
 ...
 *
 *  This describes a custom heap memory allocator for wrappers.  To set an allocator, pass it
...
/*************************************************************************
 * wrappers API functions
 *************************************************************************/

/*! @brief Initializes the wrappers library.
 *
 *  This function initializes the wrappers library.  Before most wrappers functions can
 *  be used, wrappers must be initialized, and before an application terminates wrappers
 ...
 *  application.  If wrappers finds a `MainMenu.nib` it is loaded and assumed to
...
/*! @brief Terminates the wrappers library.
 *
 *  This function destroys all remaining windows and cursors, restores any
 *  modified gamma ramps and frees any other allocated resources.  Once this
 *  function is called, you must again call @ref glfwInit successfully before
 *  you will be able to use most wrappers functions.
 *
 *  If wrappers has been successfully initialized, this function should be called
 *  before the application exits.  If initialization fails, there is no need to
 *  call this function, as it is called by @ref glfwInit before it returns
 *  failure.
 *
 *  This function has no effect if wrappers is not initialized.
 *
 ...
 *
 *  This function sets hints for the next initialization of wrappers.
 *
 *  The values you set hints to are never reset by wrappers, but they only take
 *  effect during initialization.  Once wrappers has been initialized, any values
 ...
 *
 *  This function sets the `vkGetInstanceProcAddr` function that wrappers will use for all
 *  Vulkan related entry point queries.
 *
 *  This feature is mostly useful on macOS, if your copy of the Vulkan loader is in
 *  a location where wrappers cannot find it through dynamic loading, or if you are still
 *  using the static library version of the loader.
 *
 *  If set to `NULL`, wrappers will try to load the Vulkan loader dynamically by its standard
 ...
 *
 *  The function address you set is never reset by wrappers, but it only takes effect during
 *  initialization.  Once wrappers has been initialized, any updates will be ignored until the
...
/*! @brief Retrieves the version of the wrappers library.
 *
 *  This function retrieves the major, minor and revision numbers of the wrappers
 *  library.  It is intended for when you are using wrappers as a shared library and
 ...
 *  [version string](@ref intro_version_string) of the wrappers library binary.  It describes
 *  the version, platforms, compiler and any platform or operating system specific
 *  compile-time options.  It should not be confused with the OpenGL or OpenGL ES version
 *  string, queried with `glGetString`.
 *
 *  __Do not use the version string__ to parse the wrappers library version.  The
 ...
 *
 *  @return The ASCII encoded wrappers version string.
 *
 *  @errors None.
 *
 *  @remark This function may be called before @ref glfwInit.
 ...
 *  @errors None.
 *
 *  @pointer_lifetime The returned string is allocated and freed by wrappers.  You
 ...
 *  and a human-readable description each time a wrappers error occurs.
 *
 ...
 *  are using wrappers from multiple threads, your error callback needs to be
 *  written accordingly.
 *
 ...
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED.
 *
 *  @pointer_lifetime The returned array is allocated and freed by wrappers.  You
 *  should not free it yourself.  It is guaranteed to be valid only until the
 ...
 *  freed by wrappers.  You should not free them yourself.  They are valid until the
 ...
 *  original gamma ramp for that monitor is saved by wrappers the first time this
 ...
 *  on macOS.
 *
 *  @remark @macos The wrappers window has no icon, as it is not a document
 ...
 *  Library.  The wrappers test and example programs use a custom `Info.plist`
 ...
 *
 *  @remark @wayland wrappers uses [libdecor][] where available to create its window
 ...
 *  If both XDG decorations and libdecor are unavailable, wrappers falls back to
 ...
 *
 *  The window manager may put limits on what positions are allowed.  wrappers
 ...
 *
 *  The window manager may put limits on what sizes are allowed.  wrappers cannot
 ...
 *  nothing.
 *
 *  If the specified window is a full screen window, wrappers restores the original
 ...
 *  events, window systems that require wrappers to register callbacks of its own
 *  can pass events to wrappers in response to many window system function calls.
 *  wrappers will pass those events on to the application callbacks before
 *  returning.
 *
 ...
 *  system.  This status does not change after wrappers has been initialized so you
 ...
 *
 *  __Do not use this function__ to implement things like camera controls.  wrappers
 ...
 *  of the cursor image.  Like all other coordinate systems in wrappers, the X-axis
 ...
 *  a wrappers key token.  Such keys have `key` set to `GLFW_KEY_UNKNOWN`, their
 *  state is not saved and so it cannot be queried with @ref glfwGetKey.
 *
 *  Sometimes wrappers needs to generate synthetic key events, in which case the
 ...
 *  The returned string is allocated and freed by wrappers.  You should not free it
 *  yourself.
 *
 *  If the specified joystick is not present this function will return `NULL`
 *  but will not generate an error.  This can be used instead of first calling
 ...
 *  allocated and freed by wrappers.  You should not free it yourself.
 *
 ...
 *  writing.  wrappers tries to acquire it a few times, which is almost always enough.  If it
...
/*! @brief Returns the wrappers time.
 *
 *  This function returns the current wrappers time, in seconds.  Unless the time
 *  has been set using @ref glfwSetTime it measures time elapsed since wrappers was
 *  initialized.
 *
...
/*! @brief Sets the wrappers time.
 *
 *  This function sets the current wrappers time, in seconds.  The value must be
 ...
 *  GLFW_INVALID_VALUE.
 *
 *  @remark The upper limit of wrappers time is calculated as
 ...
 *  context creation API than the one passed to this function, wrappers will still
 ...
 *  because some swap interval extensions used by wrappers do not allow the swap
...
/*! @brief Returns the Vulkan instance extensions required by wrappers.
 *
 *  This function returns an array of names of Vulkan instance extensions required
 *  by wrappers for creating Vulkan surfaces for wrappers windows.  If successful, the
 ...
 *
 *  @remark Additional extensions may be required by future versions of wrappers.
 ...
 *  physical device supports presentation to the platform wrappers was built for.
 *
 ...
 *  It is the responsibility of the caller to destroy the window surface.  wrappers
 ...
 *
 *  @remark If an error occurs before the creation call is made, wrappers returns
 *  the Vulkan error code most appropriate for the error.  Appropriate use of
 *  @ref glfwVulkanSupported and @ref glfwGetRequiredInstanceExtensions should
 *  eliminate almost all occurrences of these errors.
 *
 *  @remark @macos wrappers prefers the `VK_EXT_metal_surface` extension, with the
 ...
 *
 *  @remark @x11 By default wrappers prefers the `VK_KHR_xcb_surface` extension,
